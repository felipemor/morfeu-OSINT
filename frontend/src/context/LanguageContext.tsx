...
export const DICTIONARY: Record<Locale, Record<string, string>> = {
  pt: {
    ...
    'suite.defensive': 'AEGIS LATTICE & SOC™ (Postura & Zero-Trust)',
    'suite.defensive.desc': 'Postura Defensiva, Microsegmentação e Custódia SHA-256.',
    ...
    'menu.microsegmentation': 'Zero-Trust Microsegmentation',
  ...
  en: {
    ...
    'suite.defensive': 'AEGIS LATTICE & SOC™ (Posture & Zero-Trust)',
    'suite.defensive.desc': 'Defensive Posture, Microsegmentation & SHA-256 Custody.',
    'suite.appsec': 'HEIMDALL CODE QUALITY™ (AppSec & Refactor)',
  ...
  es: {
    ...
    'suite.defensive': 'AEGIS LATTICE & SOC™ (Postura & Zero-Trust)',
    'suite.defensive.desc': 'Postura Defensiva, Microsegmentación y Custodia SHA-256.',
    'suite.appsec': 'HEIMDALL CODE QUALITY™ (AppSec & Refactor)',
    ...
    'menu.microsegmentation': 'Microsegmentación Zero-Trust',
    'menu.codeHumanizer': 'AI Code Humanizer & Refactor',
